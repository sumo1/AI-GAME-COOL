...
class AgentLoopIntegrationTest {
    ...
    class AgentLoopResultTest {
        ...
        void testSuccessResult() {
            var result = com.sumo.agent.v2.loop.AgentLoopResult.success(
        ...
        void testFailureResult() {
            var result = com.sumo.agent.v2.loop.AgentLoopResult.failure("LLM 调用失败", 3);
